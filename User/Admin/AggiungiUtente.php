                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card-box table-responsive">
									...
									<form action="getAggiungiUtente.php" method="POST">
                              ...
                              <th colspan="3">INSERISCI I DATI DEL NUOVO UTENTE</th>
  								...
  								<tr>
    				            <td>Username</td>
                                 <td><input type="text"  maxlength="15" name="username1"></td>
  								</tr>
                                <tr>
    				            <td>Password</td>
                                 <td><input type="password"  maxlength="16" name="password1"></td>
  								</tr>
                                <tr>
    				            <td>Nome</td>
                                ...
                                <tr>
    				            <td>Cognome</td>
                                 <td><input type="text"  maxlength="25"  name="surname"></td>
  								</tr>
                                <tr>
    				            <td>Matricola</td>
                                 <td><input type="text"  maxlength="4"  name="number"></td>
  								</tr>
                                 <tr>
    				            <td>Ruolo</td>
                                 <td> <select name="mansion">
    									 <option value="G" >Amministratore Impianti</option>
						...
						<div class="container">
                        	<div class="row">
								<div class="col-sm-12">
                   						...
                   						<?php
                                    		if($_GET['success']==1){
                                        		echo '<h4 class="header-title m-t-0 m-b-30">Utente inserito con successo</h4>';
                                       		}
                                    	?>

                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card-box table-responsive">
									...
									<form action="getAggiungiAzienda.php" method="POST">
                                    <table id="datatable-buttons" class="table table-striped table-bordered">
                                       <tbody>
                                       		      		    <tr>
                              <th colspan="3">INSERISCI I DATI DELLA NUOVA AZIENDA</th>
  								</tr>
  								<tr>
    				            <td>Ragione</td>
                                 <td><input type="text"  maxlength="50" name="ragSoc1"></td>
  								</tr>
                                <tr>
    				            <td>PartitaIva</td>
                                 <td><input type="text"  maxlength="10" name="pIva1"></td>
  								</tr>
                                   <tr><td colspan="2"><input value = "Aggiungi" style="font-weight: bold; height:35px; width:130px; font-size:20px; -webkit-border-radius: 5px; -moz-border-radius: 5px; border-radius: 5px;" align="right" type="Submit";></td></tr>
                                       </tbody>
                                    </table>
                                    </form>
						...
						<div class="container">
                        	<div class="row">
								<div class="col-sm-12">
                   						...
                   						<?php
                                    		if($_GET['success']==1){
                                        		echo '<h4 class="header-title m-t-0 m-b-30">Azienda inserita con successo</h4>';
                                       		}
                                    	?>

            ...
            <div class="content-page">
                ...
                <div class="content">
                    <div class="container">
                        <?php
                                            if($_GET['delete']==1){
                                                echo '<h4 class="header-title m-t-0 m-b-30">Utente Eliminato con Successo</h4>';
                                            }
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card-box table-responsive">
                                    ...
                                    <h4 class="header-title m-t-0 m-b-30">Dati</h4>
                                    <form action="datiModificati.php" method="POST">
                                    <table id="datatable-buttons" class="table table-striped table-bordered">
                                       <tbody>
                                            <tr><th>inserisci l'Username dell'utente da modificare </th><td><input type="text" maxlength="15" name="userModify" ></td></tr>
                                            <?php
                                                if($_GET['error'] == 1){

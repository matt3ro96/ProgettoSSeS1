...
$sql="SELECT Username FROM Utenti where Ruolo = 'U' and AziendaAssociata in (Select Azienda from ResponsabilitaAmministratoreAzienda where AmministratoreImpianto = '$username');";
//esecuzione query

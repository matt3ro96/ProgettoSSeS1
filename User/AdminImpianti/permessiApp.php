                ...
                <div class="navbar navbar-default" role="navigation">
                    <div class="container">
                        ...
                        <ul class="nav navbar-nav navbar-left">
                            ...
                            <li>
                                <h4 class="page-title">Gestione dei Permessi associati agli utenti</h4>
                            </li>
                        </ul>
                ...
                <div class="sidebar-inner slimscrollleft">
                    ...
                    <div id="sidebar-menu">
                       <ul>
                         ...
                         <li><a href=# class="waves-effect"><i class="zmdi zmdi-view-list"></i> <span> Gestisci i Permessi Utenti</span> </a></li>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card-box table-responsive">
                                    ...
                                    <h4 class="header-title m-t-0 m-b-30">Associazioni Impianto Cliente</h4>
                                ...
                                <?php
                                include('getAssociazioniClienteImp.php');
                                ?>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card-box table-responsive">
                                    ...
                                    <?php
                                        if(($_GET['error'] == 1)){
                                            echo "Non puoi autorizzare Il cliente a questo impianto perchè appartengono ad Aziende differenti";
                                        }
                                    ?>
                                    <form action="autorizzare.php" method="POST">
                                    <table id="datatable-buttons" class="table table-striped table-bordered">
                                       <tbody>
                                           <tr><th>Impianti</th><td>
                                              <select name="myImp" >
                                                     <?php
                                                     include('AmministratoreImpianto.php');
                                                     ?> 
                                                    </select>
                                            </td></tr>
                                            <tr><th>Clienti</th><td>
                                              <select name="myCliente" >
                                                     <?php
                                                     include('getClientiAziende.php');
                                                     ?> 
                                                    </select>
                                            </td></tr>
                                            <tr><td colspan="2"><input type="Submit" value="Autorizza"></td></tr>
                                       </tbody>
                                    </table>
                                    </form>
                                </div>

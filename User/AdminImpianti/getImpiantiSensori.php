...
if($count>=1){ 
  ...
  while ($row = mysql_fetch_assoc($result)) {
    ...
    echo "<td>".$azienda."</td>";
    echo "<td> 
    <form action=\"aggiungiSensori.php\" method=\"POST\">
    <input type=\"hidden\" value=".$codice." name=\"myImpianto\">
    <input type=\"hidden\" value=".$azienda." name=\"myAzienda\">
    <input value=\"Aggiungi\" style=\"font-weight: bold; height:25px; width:110px; font-size:15px; -webkit-border-radius: 5px; -moz-border-radius: 5px; border-radius: 5px;\" align=\"right\" type=\"Submit\";>
    </form>
    </td>";
    echo "</tr>";
  }

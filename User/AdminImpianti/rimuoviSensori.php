                ...
                <div class="navbar navbar-default" role="navigation">
                    <div class="container">
                        ...
                        <ul class="nav navbar-nav navbar-left">
                            ...
                            <li>
                                <h4 class="page-title">Rimuovi Sensori</h4>
                            </li>
                        </ul>
                            ...
                            <div class="col-sm-12">
                                <div class="card-box table-responsive">
                                    ...
                                    <table id="datatable-buttons" class="table table-striped table-bordered">
                                    	<thead>
                                        <tr><th>Codice Sensore</th><th>Tipo Sensore</th><th>Marca Sensore</th><th>Azienda Associata</th><th>Impianto Associato</th><th>Azione</th>	</tr>
                                        </thead>
                                       <tbody>
                                       		<?php
                                                ...
                                                $sql="SELECT * FROM Sensori WHERE Impianto='$codiceImpianto' AND AziendaAssociata='$codiceAzienda'";
                                                ...
                                                if($count>=1){ 
                                                  ...
                                                  while ($row = mysql_fetch_assoc($result)) {
                                                    ...
                                                    echo "<td>".$azienda."</td>";
                                                    echo "<td> 
                                                    <form action=\"getRimuoviSensore.php\" method=\"POST\">
                                                    <input type=\"hidden\" value=".$codice." name=\"mySensore\">

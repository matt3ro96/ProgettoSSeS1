                ...
                <div class="navbar navbar-default" role="navigation">
                    <div class="container">
                        ...
                        <ul class="nav navbar-nav navbar-left">
                            ...
                            <li>
                                <h4 class="page-title">Modifica di un'Applicazione</h4>
                            </li>
                        </ul>
                         ...
                         <li class="has_sub">
                          ...
                          <li class="has_sub">
                                ...
                                <ul class="list-unstyled">
                                    ...
                                    <li><a href=# class="waves-effect"><i class="zmdi zmdi-view-list"></i> <span>Modifica un'Applicazione</span> </a></li>
                                </ul>
                          </li>
                          <li class="has_sub">
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="card-box table-responsive">
                                            ...
                                            <h4 class="header-title m-t-0 m-b-30">Dati da Modificare</h4>
                                            ...
                                            <table id="datatable-buttons" class="table table-striped table-bordered">
                                                ...
                                                <tbody>
                                                <form method="POST" action="getModificaApp.php">
                                                <?php 
                                                    ...
                                                    $myApp = $_POST['myApp'];
                                                    $sql="SELECT DISTINCT Codice, IP, Nome, AziendaAssociata FROM ApplicazioniTerzeParti JOIN ResponsabilitaAmministratoreAzienda ON AziendaAssociata=Azienda WHERE AmministratoreImpianto='$username' and Codice='$myApp'";
                                                 ...
                                                 echo "<input value=".$codice." name=\"myApp\" type=\"hidden\">";
                                                 
                                                 ?>
                                                 <tr>
                                                 <th>Seleziona il dato da modificare</th>
                                                 <td><select name ="myScelta">
                                                     	<option value = "1"> Nome Applicazione </option>
                                                     	<option value = "2"> Indirizzo IP </option>
                                                     </select>
                                                 </td>
                                                 <td><input type="text" name="myModify" maxlength="20" required></td>
                                                 <td> 
                                                 <input style="font-weight: bold; height:25px; width:110px; font-size:15px; -webkit-border-radius: 5px; -moz-border-radius: 5px; border-radius: 5px;" align="right" type="Submit";>
                                                 </td>
                                                 </tr>
                                                 </form>
                                                </tbody>
                            ...
                            <div class="container"> <!-- begin container -->
                        			<div class="row">
										<div class="col-sm-12">
                   						...
                   						<?php
                                    		if($_GET['delete']==1){
                                        		echo '<h4 class="header-title m-t-0 m-b-30">Applicazione di Terze Parti Eliminata con Successo</h4>';
                                       		}
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="card-box table-responsive">
                                            ...
                                            <h4 class="header-title m-t-0 m-b-30">Dati</h4>
                                            <form action="modifica_applicazione.php?modifica=1" method="POST">
                                            <table id="datatable-buttons" class="table table-striped table-bordered">
                                               <tbody>
                                                    <tr><th>Inserisci il codice dell'applicazione da modificare </th><td><input type="text" maxlength="4" name="myApp" ></td></tr>
								...
								<div class="container">
                        			<div class="row">
										<div class="col-sm-12">
                   						...
                   						<?php
                                    		if($_GET['success']==1){
                                        		echo '<h4 class="header-title m-t-0 m-b-30">Applicazione Modificata con Successo</h4>';
                                       		}

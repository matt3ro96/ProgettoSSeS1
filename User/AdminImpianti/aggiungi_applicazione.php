                ...
                <div class="navbar navbar-default" role="navigation">
                    <div class="container">
                        ...
                        <ul class="nav navbar-nav navbar-left">
                            ...
                            <li>
                                <h4 class="page-title">Aggiunta di un'Applicazione</h4>
                            </li>
                        </ul>
                        ...
                        <ul>
                         ...
                         <li class="has_sub">
                          ...
                          <li class="has_sub">
                                ...
                                <ul class="list-unstyled">
                                    <li><a href=# class="waves-effect"><i class="zmdi zmdi-view-list"></i> <span>Aggiungi un'Applicazione</span> </a></li>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card-box table-responsive">
									...
									<form action="get_aggiungi_applicazione.php" method="POST">
                                    <table id="datatable-buttons" class="table table-striped table-bordered">
                                       <tbody>
                                       		<tr><th>Indirizzo IP</th><td><input type="text" maxlength="15" required name="myIP" placeholder="Indirizzo IP"></td></tr>
                                            <tr><th>Nome</th><td><input type="text" maxlength="30" required name="myNomeApp" placeholder="Nome Applicazione"></td></tr>
                                            <tr><th>Azienda</th><td>
                                             <fieldset>
						...
						<div class="container">
                        	<div class="row">
								<div class="col-sm-12">
                   						...
                   						<?php
                                    		if($_GET['success']==1){
                                        		echo '<h4 class="header-title m-t-0 m-b-30">Applicazione Inserita con Successo</h4>';
                                       		}
                                            if($_GET['permesso']==1){
                                        		echo '<h4 class="header-title m-t-0 m-b-30">Non sei associato a nessuna azienda!</h4>';
                                       		}
                                    	?>

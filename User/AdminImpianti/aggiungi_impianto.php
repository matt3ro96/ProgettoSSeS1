                ...
                <div class="navbar navbar-default" role="navigation">
                    <div class="container">
                        ...
                        <ul class="nav navbar-nav navbar-left">
                            ...
                            <li>
                                <h4 class="page-title">Aggiunta di un Impianto</h4>
                            </li>
                        </ul>
                        ...
                        <ul>
                         ...
                         <li class="has_sub">
                                ...
                                <ul class="list-unstyled">
                                    <li><a href=# class="waves-effect"><i class="zmdi zmdi-view-list"></i> <span>Aggiungi un Impianto</span> </a></li>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card-box table-responsive">
									...
									<form action="get_aggiungi_impianto.php" method="POST">
                                    <table id="datatable-buttons" class="table table-striped table-bordered">
                                       <tbody>
                                       		<tr><th>Nome</th><td><input type="text" maxlength="20" required name="myNome" placeholder="Nome Dell'Impianto"></td></tr>
                                            <tr><th>Tipo</th><td><input type="text" maxlength="20" required name="myTipo" placeholder="Tipo Dell'Impianto"></td></tr>
                                            <tr><th>Data Creazione</th><td><input type="text" maxlength="10"  required name="myData" placeholder="YYYY-MM-GG"></td></tr>
                                            <tr><th>Azienda</th><td>
                                             <fieldset>
                                             		 <select name="myAzienda" >
                                                     <?php
                                                     include('getAziendeDatabase.php');
                                                     ?>	
 												 	</select>
											 </fieldset>
                                            </td></tr>
						...
						<div class="container">
                        	<div class="row">
								<div class="col-sm-12">
                   						...
                   						<?php
                                    		if($_GET['success']==1){
                                        		echo '<h4 class="header-title m-t-0 m-b-30">Impianto Inserito con Successo</h4>';
                                       		}
                                    	?>

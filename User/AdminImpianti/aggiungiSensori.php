                ...
                <div class="navbar navbar-default" role="navigation">
                    <div class="container">
                        ...
                        <ul class="nav navbar-nav navbar-left">
                            ...
                            <li>
                                <h4 class="page-title">Aggiunta di un Sensore</h4>
                            </li>
                        </ul>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card-box table-responsive">
									...
									<form action="getAggiungiSensore.php" method="POST">
                                    <table id="datatable-buttons" class="table table-striped table-bordered">
                                       <tbody>
                                       		<tr><th>Codice Sensore</th><td><input type="text" maxlength="20" required name="myCodice" placeholder="Codice del sensore"></td></tr>
                                            <tr><th>Tipo</th><td><input type="text" maxlength="20" required name="myTipo" placeholder="Tipo Del Sensore"></td></tr>
                                            <tr><th>Marca</th><td><input type="text" maxlength="20"  required name="myMarca" placeholder="Marca del Sensore"></td></tr>
                                            <?php
                                            $codiceImpianto=$_POST['myImpianto'];
                                            $codiceAzienda=$_POST['myAzienda'];
                                            echo "<input type=\"hidden\" value=".$codiceImpianto." name=\"myImpianto\">";
                                            echo "<input type=\"hidden\" value=".$codiceAzienda." name=\"myAzienda\">";
                                            if($_GET['success']!=1){
                                            	echo "<tr><th>Azienda Associata</th><td>".$codiceAzienda."</td></tr>";
                                            	echo "<tr><th>Impianto Associato</th><td>".$codiceImpianto."</td></tr>";
                                            }
                                            ?>
                                            <tr><td colspan="2"><input style="font-weight: bold; height:35px; width:130px; font-size:20px; -webkit-border-radius: 5px; -moz-border-radius: 5px; border-radius: 5px;" align="right" type="Submit";></td></tr>
                                       </tbody>
                                    </table>
                                    </form>
						...
						<div class="container">
                        	<div class="row">
								<div class="col-sm-12">
                   						...
                   						<?php
                                    		if($_GET['success']==1){
                                        		echo '<h4 class="header-title m-t-0 m-b-30">Sensore Aggiunto con Successo</h4>';
                                       		}
                                    	?>

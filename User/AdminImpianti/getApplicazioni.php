...
$sql="SELECT DISTINCT Codice, IP, Nome, AziendaAssociata FROM ApplicazioniTerzeParti JOIN ResponsabilitaAmministratoreAzienda ON AziendaAssociata=Azienda WHERE AmministratoreImpianto='$username'"; 
...
if($count>=1){ 
  ...
  while ($row = mysql_fetch_assoc($result)) {
    ...
    echo "<td>".$azienda."</td>";
    echo "<td> 
    <form action=\"eliminaApplicazioni.php\" method=\"POST\">
    <input type=\"hidden\" value=".$codice." name=\"myApp\">

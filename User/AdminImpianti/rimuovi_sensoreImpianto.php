                ...
                <div class="navbar navbar-default" role="navigation">
                    <div class="container">
                        ...
                        <ul class="nav navbar-nav navbar-left">
                            ...
                            <li>
                                <h4 class="page-title">Rimozione di un Sensore dall'Impianto</h4>
                            </li>
                        </ul>
                         ...
                         <li class="has_sub">
                          ...
                          <li class="has_sub">
                        		...
                        		<ul class="list-unstyled">
                        			...
                        			<li><a href=# class="waves-effect"><i class="zmdi zmdi-view-list"></i> <span>Rimuovi un Sensore dall'Impianto</span> </a></li>
                        		</ul>
                        	</li>
                        </ul>
                        ...
                        <div class="content">
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="card-box table-responsive">
                                            ...
                                            <h4 class="header-title m-t-0 m-b-30">Scegli l'impianto per la rimozione dei sensori</h4>
                                            ...
                                            <table id="datatable-buttons" class="table table-striped table-bordered">
                                                ...
                                                <?php 
                                                  ...
                                                  include('getImpiantiSensoriElimina.php');
                                                 ?>
                                                </tbody>
                                            </table>
                                        </div>
                        	...
                        	<div class="row">
								<div class="col-sm-12">
                   						...
                   						<?php
                                    		if($_GET['delete']==1){
                                        		echo '<h4 class="header-title m-t-0 m-b-30">Sensore Rimosso con Successo</h4>';
                                       		}
                                    	?>

                ...
                <div class="navbar navbar-default" role="navigation">
                    <div class="container">
                        ...
                        <ul class="nav navbar-nav navbar-left">
                            ...
                            <li>
                                <h4 class="page-title">Aggiunta di un Sensore in un Impianto</h4>
                            </li>
                        </ul>
                        ...
                        <ul>
                         ...
                         <li class="has_sub">
                          ...
                          <li class="has_sub">
                        		...
                        		<ul class="list-unstyled">
                        			<li><a href=# class="waves-effect"><i class="zmdi zmdi-view-list"></i> <span>Aggiungi un Sensore all'Impianto</span> </a></li>
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="card-box table-responsive">
                                            ...
                                            <h4 class="header-title m-t-0 m-b-30">Scegli l'impianto per l'aggiunta dei sensori</h4>
                                            ...
                                            <table id="datatable-buttons" class="table table-striped table-bordered">
                                                ...
                                                <?php 
                                                  ...
                                                  include('getImpiantiSensori.php');
                                                 ?>
                                                </tbody>
                                            </table>
                                        </div>

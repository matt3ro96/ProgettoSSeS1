                ...
                <div class="navbar navbar-default" role="navigation">
                    <div class="container">
                        ...
                        <ul class="nav navbar-nav navbar-left">
                            ...
                            <li>
                                <h4 class="page-title">Modifica di un Impianto</h4>
                            </li>
                        </ul>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="card-box table-responsive">
                                            ...
                                            <table id="datatable-buttons" class="table table-striped table-bordered">
                                                ...
                                                <tbody>
                                                <form method="POST" action="getModificaImpianto.php">
                                                <?php 
                                                    ...
                                                    $myImp = $_POST['myImpianto'];
                                                    $sql="SELECT CodImp, Nome, TipoImp, DataCreazione, AziendaAssociata FROM Impianto WHERE CodImp='$myImp' and AmministratoreImpianto='$username'";
                                                 ...
                                                 <td><select name ="myScelta">
                                                     	<option value = "1"> Nome Impianto </option>
                                                     	<option value = "2"> Tipo Impianto </option>
                                                     	<option value = "3"> Data Creazione </option>
                                                     </select>
                                                 </td>
                                                 <?php
                                                 echo "<td><input value=".$codice." name=\"myImpianto\" type=\"hidden\">".$codice."</td>";
                                                 ?>
                                        ...
                                        <div class="card-box table-responsive">
                                            ...
                                            <table id="datatable-buttons" class="table table-striped table-bordered">
                                                ...
                                                <?php 
                                                  ...
                                                  include('getImpiantiGestore.php');
                                                 ?>
                                                </tbody>
                                            </table>
                                        </div>
                            ...
                            <div class="container"> <!-- begin container -->
                        			<div class="row">
										<div class="col-sm-12">
                   						...
                   						<?php
                                    		if($_GET['delete']==1){
                                        		echo '<h4 class="header-title m-t-0 m-b-30">Impianto Eliminato con Successo</h4>';
                                       		}
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="card-box table-responsive">
                                            ...
                                            <h4 class="header-title m-t-0 m-b-30">Dati</h4>
                                            <form action="modifica_impianto.php?modifica=1" method="POST">
                                            <table id="datatable-buttons" class="table table-striped table-bordered">
                                               <tbody>
                                                    <tr><th>Inserisci il codice dell'impianto da modificare </th><td><input type="text" maxlength="4" name="myImpianto" ></td></tr>
								...
								<div class="container">
                        			<div class="row">
										<div class="col-sm-12">
                   						...
                   						<?php
                                    		if($_GET['success']==1){
                                        		echo '<h4 class="header-title m-t-0 m-b-30">Impianto Modificato con Successo</h4>';
                                       		}
